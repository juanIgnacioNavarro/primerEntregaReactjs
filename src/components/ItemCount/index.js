    ...
    <div className='flex items-center max-w-[300px] h-[30px] '>
      <div className='flex border border-indigo-700 rounded-tl-lg rounded-bl-lg overflow-hidden'>
        <button
          ...
          onClick={increment}
        >
          <ArrowDropUpIcon width={20} height={20} />
        </button>
      ...
      <button className='bg-indigo-900 px-4 h-full max-w-[200px] text-white flex gap-2 items-center justify-center rounded-tr-lg rounded-br-lg' onClick={handleOnAdd}>Agregar
